...
if __name__ == '__main__':
    ...
    word_list = " ".join(sentences).split() #Gets all the words in all sentences
    word_list = list(set(word_list)) #Gets the unique words
    word_dict = {w: i for i, w in enumerate(word_list)} #Assignes all the word an id for 1 to n
    #number_dict = {i: w for i, w in enumerate(word_list)} #Reverse of the word_dict
